...
using ThreePoint.Repository.Configurations;
using System.Linq;
    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typesToRegister = typeof(SystemConfigConfiguration).Assembly.GetTypes()
                .Where(q => q.GetInterface(typeof(IEntityTypeConfiguration<>).FullName) != null && !q.FullName.StartsWith("ThreePoint.Repository.Configurations.BaseConfiguration"));
